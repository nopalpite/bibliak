...
- **Rafale mode**: scan several books in a row without leaving the page — each match is added straight to the collection with a chosen type, a possible duplicate still asks for confirmation
